...
import LaunchAccountType from '@/app/shared/launch';
  ...
  return (
    <div className="relative flex grow flex-col-reverse items-center justify-center gap-y-5 px-6 pt-10 lg:flex-row lg:pt-0 xl:px-10">
      <div className="z-10 mx-auto w-full max-w-[1536px] text-center lg:text-start">
        <Title
          as="h1"
          className="mb-3 mt-12 text-2xl font-bold text-gray-1000 md:mb-5 md:text-3xl md:leading-snug xl:text-4xl xl:leading-normal 2xl:text-5xl 2xl:leading-normal"
        >
          Under development.{' '}
          <br className="hidden sm:inline-block" />Thank you for your patience, we are coming soon
          {/* <br className="hidden sm:inline-block" /> coming soon */}
        </Title>
        {/* <p className="mb-6 text-sm leading-loose text-gray-500 md:mb-8 xl:mb-10 xl:text-base xl:leading-loose">
          ...
          Coming to you soon
           <br className="hidden sm:inline-block" /> mailing list or
        ...
        <div className='mt-10 mb-12'>
          <p className="mb-4 text-sm font-bold leading-loose text-gray-900 md:mb-4 xl:mb-4 xl:text-base xl:leading-loose">
            Go to account...
          </p>
          <LaunchAccountType />
        </div>
