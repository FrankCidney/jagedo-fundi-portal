...
import { contractorActiveJobsData } from '@/data/job-data';
...
export default function ContractorActiveJobsTable({ className }: { className?: string }) {
  ...
  const {
    ...
    handleDelete,
    handleReset,
  } = useTable(contractorActiveJobsData, pageSize, filterState);

  const columns = useMemo(
    () =>
      getColumns({
        data: contractorActiveJobsData,
        sortConfig,
