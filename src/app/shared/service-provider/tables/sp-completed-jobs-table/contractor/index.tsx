...
import { contractorCompletedJobsData } from '@/data/job-data';
...
export default function ContractorCompletedJobsTable({ className }: { className?: string }) {
  ...
  const {
    ...
    handleDelete,
    handleReset,
  } = useTable(contractorCompletedJobsData, pageSize, filterState);

  const columns = useMemo(
    () =>
      getColumns({
        data: contractorCompletedJobsData,
        sortConfig,
