...
const menuItems = [
    {
        ...
        value: routes.serviceProvider.professional.profile,
    },
    {
        label: 'Account Details',
        value: routes.serviceProvider.professional.accountDetails,
    },
    {
        label: 'Uploads',
        value: routes.serviceProvider.professional.uploads,
    },
    // {
...
export default function ProfessionalEditProfileNav() {
