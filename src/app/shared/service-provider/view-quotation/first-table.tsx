                ...
                <SortableList.Item id={field.id}>
                  <div className="group grid min-h-10 grid-cols-10 gap-0 border-b border-muted dark:border-muted/20">
                    <div className="col-span-2 py-2 ps-4 pe-2">
                      <Text className='text-center font-semibold text-gray-500'>Lead Consultant</Text>
                    </div>
                    <div className="col-span-2 p-2 pb-4">
                        <Text className='text-center font-semibold text-gray-500'>Olive Wangari</Text>
                    </div>
                    <div className="col-span-2 p-2">
                        <Text className='text-center font-semibold text-gray-500'>olivewangari@gmail.com</Text>
                    </div>
                    <div className="col-span-1 p-2">
                        <Text className='text-center font-semibold text-gray-500'>Unique ID</Text>
                    </div>
                    <div className="col-span-1 p-2">
                        <Text className='text-center font-semibold text-gray-500'>40</Text>
                    </div>
                    <div className="col-span-1 p-2">
                        <Text className='text-center font-semibold text-gray-500'>10000</Text>
                    </div>
                    {/* <div className="col-span-2 p-2">
                      <QuoteInput
                        type="number"
