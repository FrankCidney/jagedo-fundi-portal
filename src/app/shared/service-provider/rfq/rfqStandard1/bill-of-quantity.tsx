    ...
    <div className="relative mt-2 mb-2">
      ...
      <div className="grid grid-cols-12 gap-2 rounded-t-md bg-gray-100 p-2 dark:bg-gray-900">
        <TableHeaderCell className="col-span-4 ps-2">
          <InvoiceInput
            placeholder="Bill No."
            {...register('invoiceTableHeader.billNo')}
          />
        </TableHeaderCell>
        <TableHeaderCell className="col-span-2 justify-end">
          <InvoiceInput
            ...
            {...register('invoiceTableHeader.works')}
          />
        </TableHeaderCell>
        <TableHeaderCell className="col-span-2 justify-end">
          <InvoiceInput
                  ...
                  <div className="group grid min-h-10 grid-cols-12 gap-0 border-b border-muted dark:border-muted/20">
                    <div className="col-span-4 py-2 pe-2">
                      <InvoiceInput
                        ...
                        placeholder="1"
                        inputClassName="[&_input]:text-end"
                        {...register(`invoiceTable.${index}.billNo`)}
                      />
                    </div>
                    <div className="col-span-2 p-2">
                      <InvoiceInput
                        type="text"
                        placeholder="Builder's work"
                        inputClassName="[&_input]:text-end"
                        {...register(`invoiceTable.${index}.works`)}
                      />
                    </div>
                    <div className="col-span-2 p-2">
                      <InvoiceInput
                        ...
                        placeholder="50,000"
                        inputClassName="[&_input]:text-end"
                        {...register(`invoiceTable.${index}.amount`)}
                      />
                    </div>
                    {/* <div className="col-span-2 p-2">
                      <InvoiceInput
