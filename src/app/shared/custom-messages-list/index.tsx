...
import PageHeader from '../commons/page-header';

dayjs.extend(relativeTime);

export default function CustomMessagesList(/*{
  setIsOpen,
}: {
          ...
          <div className="grid grid-cols-1">
            {messagesData.map((item) => (
              <div
                ...
                className="group grid cursor-pointer grid-cols-[auto_minmax(0,1fr)] gap-2.5 rounded-md py-2.5 pe-3 transition-colors hover:bg-gray-100 dark:hover:bg-gray-50"
              >
...
// export default function CustomMessagesComponent({
//   children,
// }: {
