...
export default function MaterialTableBlock() {
      ...
      <div className="grid grid-cols-12 gap-2 rounded-t-md bg-gray-100 p-2 dark:bg-gray-900">
        <TableHeaderCell className="col-span-4 ps-2">
          <InvoiceInput
            ...
            {...register('invoiceTableHeader.materialQoute.description')}
          />
        </TableHeaderCell>
        <TableHeaderCell className="col-span-2 justify-end">
          <InvoiceInput
            ...
            {...register('invoiceTableHeader.materialQoute.uom')}
          />
        </TableHeaderCell>
        <TableHeaderCell className="col-span-2 justify-end">
          <InvoiceInput
            ...
            inputClassName="[&_input]:text-end"
            {...register('invoiceTableHeader.materialQoute.quantity')}
          />
        </TableHeaderCell>
        <TableHeaderCell className="col-span-2 justify-end">
          <InvoiceInput
            placeholder="Unit Rate (KES)"
            inputClassName="[&_input]:text-end"
            {...register('invoiceTableHeader.materialQoute.unitRate')}
          />
        </TableHeaderCell>
        <TableHeaderCell className="col-span-2 justify-end">
          <InvoiceInput
            placeholder="Amount"
            inputClassName="[&_input]:text-end"
            {...register('invoiceTableHeader.materialQoute.amount')}
          />
        </TableHeaderCell>
      </div>
      <ul>
