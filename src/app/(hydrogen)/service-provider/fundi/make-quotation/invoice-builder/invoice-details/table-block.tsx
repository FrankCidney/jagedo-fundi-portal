    ...
    <div className="relative mt-2 mb-2">
      <div className="grid grid-cols-12 gap-2 rounded-t-md bg-gray-100 p-2 dark:bg-gray-900">
        <TableHeaderCell className="col-span-4 ps-2">
          <InvoiceInput
            placeholder="Fundi Type"
            {...register('invoiceTableHeader.labourQuote.title')}
          />
        </TableHeaderCell>
        <TableHeaderCell className="col-span-2 justify-end">
          <InvoiceInput
            ...
            {...register('invoiceTableHeader.labourQuote.quantity')}
          />
        </TableHeaderCell>
        <TableHeaderCell className="col-span-2 justify-end">
          <InvoiceInput
            ...
            inputClassName="[&_input]:text-end"
            {...register('invoiceTableHeader.labourQuote.rate')}
          />
        </TableHeaderCell>
        <TableHeaderCell className="col-span-2 justify-end">
          <InvoiceInput
            placeholder="Tax"
            inputClassName="[&_input]:text-end"
            {...register('invoiceTableHeader.labourQuote.frequency')}
          />
        </TableHeaderCell>
        <TableHeaderCell className="col-span-2 justify-end">
          <InvoiceInput
            placeholder="Amount"
            inputClassName="[&_input]:text-end"
            {...register('invoiceTableHeader.labourQuote.subTotal')}
          />
        </TableHeaderCell>
      </div>
      <ul>
