...
export default function MachineryTableBlock() {
    ...
    <div className="relative mt-2 mb-2">
      <div className="grid grid-cols-12 gap-2 rounded-t-md bg-gray-100 p-2 dark:bg-gray-900">
        <TableHeaderCell className="col-span-4 ps-2">
          <InvoiceInput
            placeholder="Item"
            {...register('invoiceTableHeader.machineryQuote.item')}
          />
        </TableHeaderCell>
        <TableHeaderCell className="col-span-2 justify-end">
          <InvoiceInput
            ...
            {...register('invoiceTableHeader.machineryQuote.source')}
          />
        </TableHeaderCell>
        <TableHeaderCell className="col-span-2 justify-end">
          <InvoiceInput
            ...
            inputClassName="[&_input]:text-end"
            {...register('invoiceTableHeader.machineryQuote.quantity')}
          />
        </TableHeaderCell>
        <TableHeaderCell className="col-span-2 justify-end">
          <InvoiceInput
            ...
            inputClassName="[&_input]:text-end"
            {...register('invoiceTableHeader.machineryQuote.frequency')}
          />
        </TableHeaderCell>
        <TableHeaderCell className="col-span-2 justify-end">
          <InvoiceInput
