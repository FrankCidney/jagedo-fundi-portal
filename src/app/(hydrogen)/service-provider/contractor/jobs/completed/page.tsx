...
import ContractorCompletedJobsTable from '@/app/shared/service-provider/tables/sp-completed-jobs-table/contractor';
        ...
        <>
            ...
            <div className="@container">
                <div className="grid grid-cols-1 gap-6 @4xl:grid-cols-2 @7xl:grid-cols-12 3xl:gap-8">
                    <ContractorCompletedJobsTable  className="relative @4xl:col-span-12  @7xl:col-span-8" />
                </div>
            </div>
        </>
    )
