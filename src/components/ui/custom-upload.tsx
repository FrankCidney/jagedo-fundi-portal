    ...
    <div className={cn(wrapperClassName)}>
      ...
      >
        <input
          ...
          {...dropzoneInputProps}
        />
        <div className="flex items-center @xl:flex-row @2xl:flex-row cursor-pointer px-6">
          <UploadIcon
          ...
          />
          {placeholderText || (
            <div className="@5xl::ps-10 text-center @2xl:ps-5 @2xl:text-left">
              <h5 className="text-base font-medium text-gray-700 @2xl:text-base @3xl:mb-3 @3xl:text-lg">
                Drop or select file
              </h5>
